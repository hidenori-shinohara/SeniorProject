...
This case is easy to prove since neither contraction nor deletion add any new elements to the independent sets.
...
Since the deletion of $f$ does not change the independent sets,
...
\item
  ...
  It is easy to see that simply removing the column will yield a matrix whose column vector is isomorphic to $M / e = M \backslash e$.
  Now, assume $e$ is not a loop.
