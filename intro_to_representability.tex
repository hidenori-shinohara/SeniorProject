...
Therefore, any subset of independent set is always independent.
The third property can be proved by checking each case.
Since any set with 2 or less elements is independent, we only need to care about the case when we have a set with 2 elements and a set of three elements.
